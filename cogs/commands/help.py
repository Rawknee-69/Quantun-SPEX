...
class HelpCommand(commands.HelpCommand):
  ...
  async def command_not_found(self, string: str) -> None:
    ...
    if str(self.context.author.id) in data["ids"]:
      ...
      if string in ("security", "anti", "antinuke"):
        ...
        embed1.set_footer(text=f"Made Thank you for choosing Quantun-SPEX")
        return None
  ...
  async def send_bot_help(self, mapping):
    ...
    embed.add_field(
      name="Module",
      value=
      """<:stolen_emoji:1144564511647469638> Security\n<:stolen_emoji:1144564644967620658> Extra\n<:stolen_emoji:1144564598238892073> General\n<:stolen_emoji:1144564757211398174> Invc\n<:stolen_emoji:1144564948245155840> Moderation\n<:stolen_emoji:1144565006982201474> Games\n<:stolen_emoji:1144565107611930644> Server\n<:stolen_emoji:1144564842963943547> Raidmode\n<:stolen_emoji:1144565247412277288> Vanityroles\n<:stolen_emoji:1144565294501740665> Welcomer""",
      inline=False)
