...
class Server(commands.Cog):
    ...
    async def add_role(self, *, role: int, member: discord.Member):
        if member.guild.me.guild_permissions.manage_roles:
            ...
            await member.add_roles(role, reason="Quantun-SPEX | Role Added ")

    async def remove_role(self, *, role: int, member: discord.Member):
        if member.guild.me.guild_permissions.manage_roles:
            role = discord.Object(id=int(role))
            await member.remove_roles(role, reason="Quantun-SPEX | Role Removed")
    ...
    async def _staff(self, context: Context, member: discord.Member) -> None:
        if data := getConfig(context.guild.id):
            ...
            if data["reqrole"] != None:
                ...
                description=
                f"<:lnl_error:1071036822962053211> | Staff role is not setuped in {context.guild.name}",
                color=0x2f3136)
                ...
                description=
                f"<:lnl_error:1071036822962053211> | You need {req.mention} to run this command .",
                color=0x2f3136)
                ...
                description=
                f"<:lnl_error:1071036822962053211> | Req role is not setuped in {context.guild.name}",
                color=0x2f3136)
        ...
        if data := getConfig(context.guild.id):
            ...
            if data["reqrole"] != None:
                ...
                color=0x2f3136)
                        ...
                        hacker1 = discord.Embed(
                description=
                f"<:lnl_error:1071036822962053211> | Girl role is not setuped in {context.guild.name}",
                color=0x2f3136)
                        hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
                        hacker1.set_thumbnail(url=f"{context.author.avatar}")
        ...
        if data := getConfig(context.guild.id):
            ...
            if data["reqrole"] != None:
                ...
                color=0x2f3136)
                        ...
                        hacker1 = discord.Embed(
                description=
                f"<:lnl_error:1071036822962053211> | Vip role is not setuped in {context.guild.name}",
                color=0x2f3136)
                        hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
                        hacker1.set_thumbnail(url=f"{context.author.avatar}")
        ...
        if data := getConfig(context.guild.id):
            ...
            if data["reqrole"] != None:
                ...
                color=0x2f3136)
                        ...
                        hacker1 = discord.Embed(
                description=
                f"<:lnl_error:1071036822962053211> | Guest role is not setuped in {context.guild.name}",
                color=0x2f3136)
                        hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
                        hacker1.set_thumbnail(url=f"{context.author.avatar}")
        ...
        if data := getConfig(context.guild.id):
            ...
            if data["reqrole"] != None:
                ...
                color=0x2f3136)
                        ...
                        hacker1 = discord.Embed(
                description=
                f"<:lnl_error:1071036822962053211> | Friend role is not setuped in {context.guild.name}",
                color=0x2f3136)
                        hacker1.set_author(name=f"{context.author}",
                               icon_url=f"{context.author.avatar}")
                        hacker1.set_thumbnail(url=f"{context.author.avatar}")
