      ...
      try:
                if antiSpam is True:
                  ...
                  if retry:
                      if data["punishment"] == "kick":
                        ...
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Quantun-SPEX | Anti Spam")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Quantun-SPEX | Anti Discord Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Quantun-SPEX | Anti Link")
